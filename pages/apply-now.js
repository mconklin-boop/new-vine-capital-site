    ...
    <div className="min-h-screen bg-[#050505] text-[#f4ead2]">
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
        <div className="rounded-[2rem] border border-[#8c6a2d]/20 bg-[#10100d] p-8 shadow-2xl shadow-black/20">
          <div className="text-sm uppercase tracking-[0.25em] text-[#d7bb74]">Apply Now</div>
          <h1 className="mt-3 text-4xl font-semibold text-[#f8f1de]">
            Business lending and application intake
          </h1>
          <p className="mt-4 max-w-3xl leading-8 text-[#c5bea9]">
            Use this page for fuel cards, equipment leasing, vehicle financing, working capital,
            and other business-purpose lending products.
          </p>
          ...
          <div className="mt-8 rounded-2xl border border-[#8c6a2d]/20 bg-[#0a0a08] p-6">
            ...
            <p className="mt-3 leading-7 text-[#c5bea9]">
              Until your HubSpot form is connected, use the button below to send your application
              request directly.
            </p>
            <a
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-[#8c6a2d]/20 bg-[#0d0d0b] p-6">
              <h3 className="text-lg font-semibold text-[#f4ead2]">Products may include</h3>
              <ul className="mt-4 space-y-3 text-[#c5bea9]">
                <li>Fuel cards</li>
                <li>Equipment leasing</li>
                <li>Vehicle financing</li>
                <li>Working capital</li>
                <li>Business-purpose credit solutions</li>
              </ul>
            </div>
