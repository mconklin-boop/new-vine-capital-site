          ...
          <div className="mx-auto grid max-w-7xl gap-5">
            {loans.map(([kicker, title, copy, borrower, structure]) => (
              <article key={kicker} className="grid gap-6 border-l-4 border-[#d5ad62] bg-white p-7 lg:grid-cols-[0.7fr_1fr_auto] lg:items-center">
                ...
                <a href={JOTFORM_URL} target="_blank" rel="noopener noreferrer" className="bg-[#d5ad62] px-6 py-4 text-center text-xs font-black uppercase text-[#11100b]">Submit Deal</a>
              </article>
            ))}
          </div>
        </section>
