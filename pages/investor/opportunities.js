...
export default function Opportunities({ user, deals = [] }) {
  ...
  return (
    <PortalLayout user={user} title="Active Deal Opportunities">
      <section className="border border-white/10 bg-[#111613] p-6 md:p-8"><p className="text-xs font-black uppercase tracking-[0.18em] text-[#d5ad62]">Private Deal Flow</p><h3 className="mt-3 font-serif text-3xl md:text-5xl">Review assigned opportunities and controlled deal rooms.</h3><p className="mt-4 max-w-4xl leading-8 text-white/65">Opportunities are shown only after New Vine Capital assigns them to your investor profile. Commitments remain subject to suitability review, allocation availability, legal documentation, and offering terms.</p></section>
