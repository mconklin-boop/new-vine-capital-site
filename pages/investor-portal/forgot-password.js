    ...
    <div className="min-h-screen bg-[#050605] text-white">
      <main className="grid min-h-screen place-items-center px-5 py-16">
        <section className="w-full max-w-2xl border border-white/10 bg-[#111613] p-8 shadow-2xl shadow-black/40">
          ...
          <div className="mt-8 grid gap-3 text-white/70"><p><strong className="text-white">Email:</strong> deals@newvinecapital.com</p><p><strong className="text-white">Phone:</strong> 720-460-0337</p></div>
